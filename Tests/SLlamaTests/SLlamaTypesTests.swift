...
struct SLlamaTypesTests {
    ...
    func constantsAndMagicValues() throws {
        // Test that constants are properly defined
        #expect(SLlamaTokenNull == -1, "SLlamaTokenNull should be -1")
        #expect(SLlamaDefaultSeed == 0xFFFF_FFFF, "SLlamaDefaultSeed should be 0xFFFFFFFF")
        #expect(SLlamaFileMagicGGLA == 0x6767_6C61, "SLlamaFileMagicGGLA should be correct magic")
        #expect(SLlamaFileMagicGGSN == 0x6767_736E, "SLlamaFileMagicGGSN should be correct magic")
        #expect(SLlamaFileMagicGGSQ == 0x6767_7371, "SLlamaFileMagicGGSQ should be correct magic")
        #expect(SLlamaSessionMagic == 0x6767_736E, "SLlamaSessionMagic should be correct magic")
        #expect(SLlamaSessionVersion == 9, "SLlamaSessionVersion should be 9")
        #expect(SLlamaStateSeqMagic == 0x6767_7371, "SLlamaStateSeqMagic should be correct magic")
        #expect(SLlamaStateSeqVersion == 2, "SLlamaStateSeqVersion should be 2")
    }

    @Test("Enum extensions")
    func enumExtensions() throws {
